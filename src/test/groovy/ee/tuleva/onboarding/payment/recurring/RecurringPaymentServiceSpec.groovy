...
class RecurringPaymentServiceSpec extends Specification {
  ...
  def "can get a recurring payment link"() {
    ...
    LHV      | "https://www.lhv.ee/portfolio/payment_standing_add.cfm?i_receiver_name=AS%20Pensionikeskus" +
        "&i_receiver_account_no=EE547700771002908125&i_payment_desc=30101119828,%20EE3600001707&i_payment_clirefno=993432432" +
    ...
    SEB      | "https://e.seb.ee/web/ipank?act=PENSION3_STPAYM&saajakonto=EE141010220263146225&saajanimi=" +
        "AS%20Pensionikeskus&selgitus=30101119828,%20EE3600001707&viitenr=993432432&summa=12.34&alguskuup=10.01.2020&sagedus=M"
