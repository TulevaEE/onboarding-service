...
class MemberPaymentNotificationControllerSpec extends BaseControllerSpec {
  ...
  def "incoming payment is correctly mapped to DTO, mac is validated and a member is created in the database with the correct name"() {
    ...
    def perform = mvc.perform(post("/notifications/payments")
        ...
        .param("mac",
            "c9bd73b2eaac5f73b15c24f4a0d06ec5d3bb14bbbc3ce2e3c709d1587f44e574a690a632190b3b8cb831da82d0a706daed7d011878cabaedf54236c3c45f6fbf"))
  ...
  def "member is not created when the payment status is not COMPLETED"() {
    ...
    def perform = mvc.perform(post("/notifications/payments")
        ...
        .param("json", json)
        .param("mac",
            "53b1ace42be9af8667a4e2be5c82b28f9f7e217f2353888f01f9de6d7da0aea95d1913fb9345abcf03edc9c796a5178e2b2d772412280b951e7612834bcff232"))
  ...
  def "doesn't try to create the member more than once"() {
    ...
    def perform = mvc.perform(post("/notifications/payments")
        ...
        .param("json", mapper.writeValueAsString(json))
        .param("mac",
            "72226bd686fd3288c53784f3297164933619877cb13be6c4da91a7201fd20f4a6378abbdeb6bdbc6601905f1f052c4227dd15b9a50f42a192cde2686d1f853af"))
