...
public class LedgerTestController {
  ...
  @GetMapping("/account")
  public List<LedgerAccount> getAccounts(@AuthenticationPrincipal AuthenticatedPerson authenticatedPerson) {
    Long userId = authenticatedPerson.getUserId();
    User user = userService.getById(userId);

    LedgerParty ledgerParty = ledgerPartyService.getPartyForUser(user);
  ...
  @PostMapping("/account")
  public LedgerAccount createAccount(@AuthenticationPrincipal AuthenticatedPerson authenticatedPerson) {
    Long userId = authenticatedPerson.getUserId();
    User user = userService.getById(userId);
