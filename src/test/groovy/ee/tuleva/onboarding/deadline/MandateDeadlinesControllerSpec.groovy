...
class MandateDeadlinesControllerSpec extends BaseControllerSpec {
  ...
  def "can get mandate deadlines"() {
    ...
    mockMvc.perform(get('/v1/mandate-deadlines'))
      ...
      .andExpect(jsonPath('$.periodEnding', is("2021-03-31T20:59:59.999999999Z")))
      .andExpect(jsonPath('$.transferMandateCancellationDeadline', is("2021-03-31T20:59:59.999999999Z")))
      .andExpect(jsonPath('$.transferMandateFulfillmentDate', is("2021-05-03")))
      .andExpect(jsonPath('$.earlyWithdrawalCancellationDeadline', is("2021-07-31T20:59:59.999999999Z")))
      .andExpect(jsonPath('$.earlyWithdrawalFulfillmentDate', is("2021-09-01")))
      .andExpect(jsonPath('$.withdrawalCancellationDeadline', is("2021-03-31T20:59:59.999999999Z")))
