...
class CashFlowFixture {
    ...
    public static CashFlowStatement cashFlowFixture() {
        ...
        return CashFlowStatement.builder()
            .startBalance([
                "1": CashFlow.builder().date(randomDate).amount(1000.0).currency("EUR").isin("1").build(),
            ...
            .endBalance([
                "1": CashFlow.builder().date(randomDate).amount(1100.0).currency("EUR").isin("1").build(),
            ...
            .transactions([
                CashFlow.builder().date(randomDate).amount(-100.0).currency("EUR").isin("1").build(),
