...
public class PensionTransactionFixture {

  static final String JOHN_DOE_PERSONAL_ID = "12345678901";
  static final String JANE_SMITH_PERSONAL_ID = "12345678902";

  static PensionTransaction johnDoeTransaction() {
    return PensionTransaction.builder()
  ...
  static PensionTransaction janeSmithTransaction() {
    return PensionTransaction.builder()
        .date(LocalDate.of(2023, 1, 15))
