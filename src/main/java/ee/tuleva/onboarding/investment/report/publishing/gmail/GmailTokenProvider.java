...
class GmailTokenProvider {
  ...
  private static final String GMAIL_COMPOSE_SCOPE = "https://www.googleapis.com/auth/gmail.compose";
  ...
  GmailTokenProvider(
      String base64ServiceAccountJson, String delegateUser, RestClient restClient, Clock clock) {
