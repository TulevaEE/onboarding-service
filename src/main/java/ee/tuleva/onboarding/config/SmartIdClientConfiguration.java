...
public class SmartIdClientConfiguration {
    ...
    @Bean
    public AuthenticationResponseValidator authenticationResponseValidator(ResourceLoader resourceLoader) {
        AuthenticationResponseValidator validator = new AuthenticationResponseValidator();
        initializeTrustedCertificatesFromTrustStore(validator, resourceLoader);
        return validator;
    }

    private void initializeTrustedCertificatesFromTrustStore(AuthenticationResponseValidator validator,
