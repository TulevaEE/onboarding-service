...
public record OcfSnapshot(
    ...
    int version,
    OcfMethodology methodology,
    BigDecimal managementFeeRate,
    BigDecimal depotFeeRate,
    BigDecimal underlyingFundCost,
    @Nullable BigDecimal underlyingFundCostGross,
    @Nullable BigDecimal underlyingFundCostNet,
    RebateBasis rebateBasis,
  ...
  public static OcfSnapshot computed(
      ...
      BigDecimal managementFeeRate,
      BigDecimal depotFeeRate,
      BigDecimal underlyingFundCostGross,
      BigDecimal underlyingFundCostNet,
      RebateBasis rebateBasis,
      BigDecimal transactionCostRate,
      BigDecimal totalOcf,
      boolean complete,
    ...
    return new OcfSnapshot(
        ...
        snapshotMonth,
        UNVERSIONED,
        OcfMethodology.EX_ANTE_NET_ASSETS_V1,
        managementFeeRate,
        depotFeeRate,
        rebateBasis == RebateBasis.GROSS ? underlyingFundCostGross : underlyingFundCostNet,
        underlyingFundCostGross,
        underlyingFundCostNet,
        rebateBasis,
        transactionCostRate,
        totalOcf,
        complete,
  ...
  public static OcfSnapshot fromResultSet(ResultSet rs, int rowNum) throws SQLException {
    ...
    return new OcfSnapshot(
        ...
        rs.getInt("version"),
        OcfMethodology.valueOf(rs.getString("methodology")),
        rs.getBigDecimal("management_fee_rate"),
        rs.getBigDecimal("depot_fee_rate"),
        rs.getBigDecimal("underlying_fund_cost"),
        rs.getBigDecimal("underlying_fund_cost_gross"),
        rs.getBigDecimal("underlying_fund_cost_net"),
        RebateBasis.valueOf(rs.getString("rebate_basis")),
