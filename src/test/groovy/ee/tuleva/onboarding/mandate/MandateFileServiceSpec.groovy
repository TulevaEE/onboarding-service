...
class MandateFileServiceSpec extends Specification {
  ...
  MandateFileService service = new MandateFileService(mandateRepository,
      mandateContacts, compositeMandateFileCreator, userService)
  ...
  def "getMandateFiles: generates mandate content files"() {
    given:
    MandateContactDetails sampleContactDetails = contactDetailsFixture()
    ...
    1 * mandateContacts.getContactDetails(user) >> sampleContactDetails
