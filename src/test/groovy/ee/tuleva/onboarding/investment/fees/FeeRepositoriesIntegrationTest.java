...
class FeeRepositoriesIntegrationTest {
  ...
  @Nested
  class CustodyFeeInstrumentTypeRepositoryTests {

    @Autowired private CustodyFeeInstrumentTypeRepository custodyFeeInstrumentTypeRepository;
    ...
    @Test
    void findAllValidOn_returnsValidInstrumentTypes() {
      LocalDate validFrom = LocalDate.of(2025, 1, 1);
      LocalDate checkDate = LocalDate.of(2025, 6, 15);
      insertInstrumentType(
          "TEST1234567890", CustodyInstrumentType.ETF, new BigDecimal("0.0001"), validFrom, null);
      insertInstrumentType(
          "TEST9876543210",
          CustodyInstrumentType.INDEXFUND,
          new BigDecimal("0.0002"),
          validFrom,
          null);

      var result = custodyFeeInstrumentTypeRepository.findAllValidOn(checkDate);

      assertThat(result).hasSize(2);
    }

    @Test
    void findAllValidOn_filtersExpiredTypes() {
      LocalDate validFrom = LocalDate.of(2025, 1, 1);
      LocalDate validTo = LocalDate.of(2025, 3, 31);
      LocalDate checkDate = LocalDate.of(2025, 6, 15);
      insertInstrumentType(
          "TEST1234567890",
          CustodyInstrumentType.ETF,
    ...
    @Test
    void findAllValidOn_filtersNotYetValidTypes() {
      LocalDate validFrom = LocalDate.of(2025, 7, 1);
      LocalDate checkDate = LocalDate.of(2025, 6, 15);
      insertInstrumentType(
          "TEST1234567890", CustodyInstrumentType.ETF, new BigDecimal("0.0001"), validFrom, null);
    ...
    private void insertInstrumentType(
        String isin,
