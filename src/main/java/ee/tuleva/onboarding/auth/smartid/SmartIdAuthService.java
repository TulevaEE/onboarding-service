...
public class SmartIdAuthService {
        ...
        () -> {
          try {
            ...
            SmartIdAuthenticationResponse authenticationResponse =
                getSmartIdAuthenticationResponse(nationalIdentity, authenticationHash);
  ...
  SmartIdAuthenticationResponse getSmartIdAuthenticationResponse(
      NationalIdentity nationalIdentity, AuthenticationHash authenticationHash) {
  ...
  SmartIdAuthenticationResult getAuthenticationResult(
      SmartIdAuthenticationResponse authenticationResponse) {
