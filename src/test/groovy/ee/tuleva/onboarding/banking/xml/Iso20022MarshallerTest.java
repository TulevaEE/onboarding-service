...
public class Iso20022MarshallerTest {
  ...
  public void unmarshalStatementResponseClass() {
    ...
    assertEquals("EE062200221055091967", parsed.getBankStatementAccount().iban());
    ...
    assertEquals(0, new BigDecimal("5898.24").compareTo(secondBalance.balance()));
    ...
    assertEquals("EE042200000000100032", firstEntry.details().getIban());
    assertEquals(Optional.of("38888888888"), firstEntry.details().getIdCode());
    ...
    assertEquals("EE082200000000100057", secondEntry.details().getIban());
    assertEquals(Optional.of("38888888888"), secondEntry.details().getIdCode());
    ...
    assertEquals("EE532200000000010007", thirdEntry.details().getIban());
    assertEquals(Optional.of("38888888888"), thirdEntry.details().getIdCode());
    ...
    assertEquals("EE522200000000100041", fourthEntry.details().getIban());
    assertEquals(Optional.of("38888888888"), fourthEntry.details().getIdCode());
