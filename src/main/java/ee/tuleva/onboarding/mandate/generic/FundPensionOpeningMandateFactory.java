...
@Component
public class FundPensionOpeningMandateFactory extends MandateFactory<FundPensionOpeningMandateDetails>  {

  public FundPensionOpeningMandateFactory(UserService userService, EpisService episService, UserConversionService conversionService, ConversionDecorator conversionDecorator) {
    super(userService, episService, conversionService, conversionDecorator);
  }

  @Override
  public Mandate createMandate(AuthenticatedPerson authenticatedPerson, GenericMandateCreationDto<FundPensionOpeningMandateDetails> mandateCreationDto) {
    ...
    mandate.setMandateType(MandateType.FUND_PENSION_OPENING);
    mandate.setPillar(details.getPillar()); // TODO legacy field
