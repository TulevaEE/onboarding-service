...
class WithdrawalsControllerIntegrationTest {
  ...
  void testWithdrawalEligibility() {
    ...
    restTestClient
        ...
        .isEqualTo(false)
        .jsonPath("$.canWithdrawThirdPillarWithReducedTax")
        .isEqualTo(false)
        .jsonPath("$.canWithdrawThirdPillarWithReducedTaxFrom")
        .isEqualTo("2043-12-12")
        .jsonPath("$.earlyRetirementDate")
        .isEqualTo("2049-03-12")
