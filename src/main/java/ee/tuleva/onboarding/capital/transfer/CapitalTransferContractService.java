...
public class CapitalTransferContractService {
  ...
  public CapitalTransferContract create(
    ...
    User sellerUser = userService.getById(sellerPerson.getUserId());
        ...
        CapitalTransferContract.builder()
            ...
            .originalContent(
                "Contract content placeholder"
                    .getBytes()) // TODO: Placeholder for actual PDF generation
            .digiDocContainer(new byte[0]) // TODO
            .build();
  ...
  public CapitalTransferContract confirmPaymentBySeller(Long id) {
    ...
    log.info("Payment confirmed by seller for contract {}. Adding to Metabase queue.", id);
    // TODO: Metabase integration
    return contractRepository.save(contract);
  }
