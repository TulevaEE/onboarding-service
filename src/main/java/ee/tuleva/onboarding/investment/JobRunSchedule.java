...
public final class JobRunSchedule {
  ...
  // Raw data import from S3 to database
  public static final String IMPORT_MORNING = "0 0 11 * * *";
  public static final String IMPORT_AFTERNOON = "0 0 15 * * *";

  // Parsing from database to domain entities (5 minutes after import)
  public static final String PARSE_MORNING = "0 5 11 * * *";
